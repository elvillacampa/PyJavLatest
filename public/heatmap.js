/*1st NANO*/
const sio = io('http://172.23.251.153:8080');
sio.on('connect', () => {
...
function vehicleComponent(track_id, width, height, image, color, speed, x, y, type, position, component_type) {
    ...
    this.update = function () {
        ...
        ctx.arc(-r, r,brushSize,0,2*Math.PI, true);  
        ctx.closePath();
        ctx.fill();
        ctx.restore();  
    }
...
// const sio2 = io('http://172.23.247.162:8080');
// sio2.on('connect', () => {
...
// const sio3 = io('http://172.23.247.162:8080');
// sio3.on('connect', () => {
...
// const sio4 = io('http://172.23.247.162:8080');
// sio4.on('connect', () => {
